...
var metamask = {
  ...
  getIcon: async () => (await import("./metamask-L7CP6WFO.js")).default,
...
var exodus = {
  ...
  getIcon: async () => (await import("./exodus-3GJEGC2R.js")).default,
...
var brave = {
  ...
  getIcon: async () => (await import("./brave-TAVYZP2M.js")).default,
...
var binance = {
  ...
  getIcon: async () => (await import("./binance-CYKX2RAJ.js")).default,
  getInterface: async () => {
    let tempBNBProvider = {
      ...window.BinanceChain
    };
...
var coinbase = {
  ...
  getIcon: async () => (await import("./coinbase-NLFN4GX2.js")).default,
  getInterface: async () => {
...
var detected = {
  ...
  getIcon: async () => (await import("./detected-JHFPVYNG.js")).default,
  getInterface: async () => ({
...
var trust = {
  ...
  getIcon: async () => (await import("./trust-Z3YSXG6H.js")).default,
  getInterface: async () => ({
...
var opera = {
  ...
  getIcon: async () => (await import("./opera-YC4YU75Z.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
...
var status = {
  ...
  getIcon: async () => (await import("./status-MR63XKMI.js")).default,
  getInterface: async () => {
...
var alphawallet = {
  ...
  getIcon: async () => (await import("./alphawallet-OU4CLF2Q.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var atoken = {
  ...
  getIcon: async () => (await import("./atoken-U4PU5AFW.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var bitpie = {
  ...
  getIcon: async () => (await import("./bitpie-5HTODKZM.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var blockwallet = {
  ...
  getIcon: async () => (await import("./blockwallet-KFJ5BMXN.js")).default,
...
var frame = {
  ...
  getIcon: async () => (await import("./frame-UCZDF2MN.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["desktop"]
...
var huobiwallet = {
  ...
  getIcon: async () => (await import("./huobiwallet-N2PXF7ND.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var hyperpay = {
  ...
  getIcon: async () => (await import("./hyperpay-6277RY5P.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var imtoken = {
  ...
  getIcon: async () => (await import("./imtoken-AZIJILN5.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var liquality = {
  ...
  getIcon: async () => (await import("./liquality-IYZEX5A5.js")).default,
  getInterface: async () => {
...
var meetone = {
  ...
  getIcon: async () => (await import("./meetone-OKWWYUSR.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var mykey = {
  ...
  getIcon: async () => (await import("./mykey-PMFT376Q.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var ownbit = {
  ...
  getIcon: async () => (await import("./ownbit-SOEMJQUF.js")).default,
  getInterface: async () => {
    const provider = createEIP1193Provider(window.ethereum, {
      eth_chainId: ({ baseRequest }) => baseRequest({ method: "eth_chainId" }).then((id) => `0x${parseInt(id).toString(16)}`),
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
...
var tokenpocket = {
  ...
  getIcon: async () => (await import("./tokenpocket-GWIQCN62.js")).default,
...
var tp = {
  ...
  getIcon: async () => (await import("./tp-4IZ6I344.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var xdefi = {
  ...
  getIcon: async () => (await import("./xdefi-SO6ILL6Q.js")).default,
  getInterface: async () => ({
...
var oneInch = {
  ...
  getIcon: async () => (await import("./oneInch-MGTVIN7R.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["mobile"]
...
var tokenary = {
  ...
  getIcon: async () => (await import("./tokenary-3OOUU4I5.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var tally = {
  ...
  getIcon: async () => (await import("./tallywallet-PS6ADEUS.js")).default,
  getInterface: async () => ({
...
var rabby = {
  ...
  getIcon: async () => (await import("./rabby-P7YEXPPK.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["desktop"]
...
var mathwallet = {
  ...
  getIcon: async () => (await import("./mathwallet-WODKK2WI.js")).default,
...
var gamestop = {
  ...
  getIcon: async () => (await import("./gamestop-JLEISXIM.js")).default,
  getInterface: async () => ({
...
var bitkeep = {
  ...
  getIcon: async () => (await import("./bitkeep-LIBQ3V7L.js")).default,
  getInterface: async () => ({
...
var sequence = {
  ...
  getIcon: async () => (await import("./sequence-YXCMEMMY.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["all"]
...
var core = {
  ...
  getIcon: async () => (await import("./core-D2GRVB62.js")).default,
...
var bitski = {
  ...
  getIcon: async () => (await import("./bitski-2LPWBQUF.js")).default,
  getInterface: async () => ({
...
var enkrypt = {
  ...
  getIcon: async () => (await import("./enkrypt-WUOPW2S7.js")).default,
  getInterface: async () => {
  ...
  return (helpers) => {
    ...
    const validWallets = filteredWallets.filter(({ injectedNamespace, checkProviderIdentity, label }) => {
      ...
      if (provider.providers && Array.isArray(provider.providers)) {
        walletExists = !!provider.providers.filter((provider2) => checkProviderIdentity({ provider: provider2, device })).length;
      } else {
        walletExists = checkProviderIdentity({ provider, device });
      }
      if (walletExists && provider.isMetaMask && !provider.overrideIsMetaMask && label !== ProviderLabel.MetaMask && label !== "Detected Wallet") {
        removeMetaMask = true;
      }
      return walletExists;
    });
